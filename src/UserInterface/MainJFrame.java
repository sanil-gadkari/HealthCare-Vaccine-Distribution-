...
public class MainJFrame extends javax.swing.JFrame {
   ...
   private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    ...
    private void initComponents() {
        ...
        container.setMaximumSize(new java.awt.Dimension(1280, 800));
        container.setMinimumSize(new java.awt.Dimension(1280, 800));
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if (userAccount == null) {
            ...
            container.add("workArea", userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inEnterprise, system,n));
